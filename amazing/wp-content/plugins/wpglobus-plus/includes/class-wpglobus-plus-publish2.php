...
//				), 0 );
		...
		public function on_admin_scripts() {
			...
			if ( WPGlobus_WP::is_pagenow( array( 'post.php', 'post-new.php' ) ) ) :
				...
				wp_register_script(
					...
					plugin_dir_url( __FILE__ ) . 'js/wpglobus-plus-publish' . self::$_SCRIPT_SUFFIX . ".js",
					array( 'jquery' ),
		 ...
		 * @return array
		 */		
		public function set_status( $order ) {
			...
			if ( in_array( $order['status'], array( 'draft' ) ) ) {
		...
		public function set_draft_callback() {
			...
			<div class="wrap">
				...
				?>
				<hr />
				<a href="<?php echo admin_url( 'admin.php' ); ?>?page=wpglobus-plus-options&tab=publish" class="button button-primary">
