...
function clickmeeting_shortcode($atts, $content = null)
{
    ...
    return '<div class="clickmeeting-iframe"><iframe src="' . esc_attr($content) .'?lang='. esc_attr($lang) .'&popup="'. esc_attr($popup) .'" width="'. esc_attr($width) .'" height="'. esc_attr($height). '" scrolling="no" frameborder="0" allowfullscreen style="display: block;border: none;"></iframe></div>';
}
